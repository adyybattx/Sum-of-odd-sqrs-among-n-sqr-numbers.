# Sum of odd sqrs among n sqr numbers.
...
Let's have a look at odd numbers. 1,3,5,7,9,11,13,and on and on. Basically, 2n+1 (n starts from 0).
...
We can then store these numbers to an array and have something like 
(8 * arr[i])+ 1
